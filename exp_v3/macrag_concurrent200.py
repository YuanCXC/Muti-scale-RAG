...
class MacRAGExperiment:
    ...
    def load_resources(self) -> None:
        logger.info("加载 HotpotQA 资源（MacRAG）")
...
"""
    ...
    def _create_run_dir(self) -> Path:
        ...
        run_dir = self.config.output_dir / f"macrag_{timestamp}"
    ...
    def run(self) -> Dict[str, Any]:
        ...
        rows_by_method = self.evaluate_methods(method_fns, desc="MacRAG")
        method_rows = rows_by_method.get("MacRAG", [])
        ...
        route_rows = self.route_distribution_table(method_rows)
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="MacRAG 对比实验（分阶段并发）")
    ...
    result = MacRAGExperiment(config).run()
